...
tomato_path = os.path.join(BASE_DIR, "assets", "tomato.png")
watermelon_path = os.path.join(BASE_DIR, "assets", "watermelon.png")
lemon_path = os.path.join(BASE_DIR, "assets", "lemon.png")
pear_path = os.path.join(BASE_DIR, "assets", "pear.png")
tomato_img = pygame.image.load(tomato_path)
...
def character_select(number):
    ...
    while running:
        ...
        CHARACTER_SELECT_TEXT = get_font(100).render("CHOOSE YOUR \n    BRO!    ", True, "#b68f40")
        CHARACTER_SELECT_RECT = CHARACTER_SELECT_TEXT.get_rect(center=(640, 160))

        TOMATO_BUTTON = Button(image=pygame.image.load("assets/Tomato Rect.png"), pos=(640, 330), 
                                text_input="TOMATO", font=get_font(75), base_color="#d7fcd4", hovering_color="White")
        WATERMELON_BUTTON = Button(image=pygame.image.load("assets/Watermelon Rect.png"), pos=(640, 440), 
                                text_input="WATERMELON", font=get_font(75), base_color="#d7fcd4", hovering_color="White")
        LEMON_BUTTON = Button(image=pygame.image.load("assets/Lemon Rect.png"), pos=(640, 550), 
                                text_input="LEMON", font=get_font(75), base_color="#d7fcd4", hovering_color="White")
        PEAR_BUTTON = Button(image=pygame.image.load("assets/Pear Rect.png"), pos=(640, 660), 
                                text_input="PEAR", font=get_font(75), base_color="#d7fcd4", hovering_color="White")
        
        screen.blit(CHARACTER_SELECT_TEXT, CHARACTER_SELECT_RECT)

        for button in [TOMATO_BUTTON, WATERMELON_BUTTON, LEMON_BUTTON, PEAR_BUTTON]:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if PLAY_BUTTON.checkForInput(MENU_MOUSE_POS):
                    character_select(character_num)
